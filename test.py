...
model.load_weights('D:/ML_python/Retinal-Vessel-Segmentation-using-variants-of-UNET-main/DRIVE(jpg)/retina_Unet_150epochs.hdf5') #loading weights


path1 = 'D:/ML_python/Retinal-Vessel-Segmentation-using-variants-of-UNET-main/DRIVE(jpg)/test/images'    #test dataset images directory path
path2 = 'D:/ML_python/Retinal-Vessel-Segmentation-using-variants-of-UNET-main/DRIVE(jpg)/test/mask'     #test dataset mask directory path
...
reconstructed_image = []
test_img = skimage.io.imread('D:/ML_python/Retinal-Vessel-Segmentation-using-variants-of-UNET-main/HRF dataset/images/15_dr.JPG') #test image
